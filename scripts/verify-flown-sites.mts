...
// run start`, matching every other map-asserting verify script in this repo (never `pnpm dev` —
// see verify-sites-map.mts's own doc comment on why dev's extra overhead can mask real timing bugs).
//
