...
// builder itself is domain-specific, so a single copy here replaced what used to be two
// byte-for-byte-identical copies (comments-query-builder-fake.ts and follows-query-builder-fake.ts).
